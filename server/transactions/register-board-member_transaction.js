...
class RegisterBoardMemberTransaction extends BaseTransaction {
  static get TYPE() {
    return 102;
  }

  static get FEE() {
    return utils.convertLSKToBeddows("100000");
  }
...
module.exports = RegisterBoardMemberTransaction;
